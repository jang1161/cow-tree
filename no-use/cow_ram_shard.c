...
void cow_close(cow_tree *t)
{
...

    {
        ...
        fprintf(stderr,
                "[ram-shard] page_cache tl_hit=%lu ram_hit=%lu disk_reads=%lu\n"
                "[ram-shard] q_lock_wait_avg_us insert=%.2f writer=%.2f\n"
                "[ram-shard] avg_batch_size=%.2f batches=%lu items=%lu\n"
                "[ram-shard] page_appends=%lu\n",
