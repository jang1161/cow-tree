...
/* Queue sharding for cow_btrfs2 */
#define QUEUE_SHARD_COUNT 16
...
typedef struct
{
    ...
    /* Sequencer thread for append operations with sharded queue */
    pthread_t writer_tid;
    queue_shard_t queue_shards[QUEUE_SHARD_COUNT];
    ...
    /* Producer contention stats */
    _Atomic(uint64_t) stat_shard_lock_wait_ns_insert;
    _Atomic(uint64_t) stat_shard_lock_wait_samples_insert;
