...
typedef struct
{
    ...
    pthread_mutex_t q_lock[QUEUE_SHARDS];
    insert_req *q_head[QUEUE_SHARDS];
    insert_req *q_tail[QUEUE_SHARDS];
    _Atomic(uint64_t) queued_items;
    _Atomic(uint32_t) q_rr_hint;
