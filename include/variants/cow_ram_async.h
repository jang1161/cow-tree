...
typedef struct
{
    ...
    _Atomic(uint64_t) stat_async_flush_levels_samples;
    _Atomic(uint64_t) stat_async_flush_levels_sum;
    _Atomic(uint64_t) stat_async_flush_workers_samples;
    _Atomic(uint64_t) stat_async_flush_workers_sum;
    _Atomic(uint64_t) stat_async_flush_level_width_samples;
    _Atomic(uint64_t) stat_async_flush_level_width_sum;
    _Atomic(uint64_t) stat_async_flush_level_width_max;
    _Atomic(uint64_t) stat_async_flush_parallel_ns_samples;
    _Atomic(uint64_t) stat_async_flush_parallel_ns_sum;

    uint64_t *stat_batch_latency_samples_ns;
    size_t stat_batch_latency_samples_used;
    size_t stat_batch_latency_samples_cap;
    uint64_t *stat_flush_latency_samples_ns;
    size_t stat_flush_latency_samples_used;
    size_t stat_flush_latency_samples_cap;

    void *ram_slots;
    size_t ram_cap;
    size_t ram_used;
    pthread_mutex_t ram_table_lock;
} cow_tree;
