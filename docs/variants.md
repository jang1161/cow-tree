...
| shard | src/variants/cow_shard.c | include/variants/cow_shard.h | make bench-shard | cow_test_shard | btrfs2 renamed shard variant |
...
| zfs | src/variants/cow_zfs.c | - (standalone) | make bench-zfs | cow_test_zfs | standalone main 포함 zfs 실행 바이너리 |
